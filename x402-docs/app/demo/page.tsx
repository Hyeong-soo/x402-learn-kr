        ...
        <div className="relative z-10 text-center px-4 max-w-2xl">
          ...
          <div className="glass rounded-2xl p-6 mb-6 border border-cyan-500/30">
            ...
            <div className="p-4 rounded-xl bg-purple-500/10 border border-purple-500/30 mb-4">
              <p className="text-xs text-purple-400 mb-3 font-medium">Claude Opus 4.5 기준 ($5/1M tokens)</p>
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              ...
              <div className="p-3 rounded-lg bg-emerald-500/10 text-center">
                <p className="text-2xl font-bold text-emerald-400">2.6x</p>
                <p className="text-xs text-white/50">비용 대비 이득</p>
              </div>
              <div className="p-3 rounded-lg bg-purple-500/10 text-center">
                <p className="text-2xl font-bold text-purple-400">165%</p>
